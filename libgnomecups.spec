...
# https://bugzilla.redhat.com/show_bug.cgi?id=559244
Patch7: libgnomecups-marathi.patch
# https://bugzilla.redhat.com/show_bug.cgi?id=616313
Patch8: libgnomecups-translations.patch
...
%changelog
* Fri Jul 23 2010 Marek Kasik <mkasik@redhat.com> - 0.2.3-9
- Add as, bn_IN, kn, ko, ml, ta, te, ru and or translations
- Modify de, es, fr, gu, hi, it, ja, mr, pa, pt_BR, zh_CN
         and zh_TW translations
- Patch by Ankit Patel
- Resolves: #616313

* Thu Feb 25 2010 Marek Kasik <mkasik@redhat.com> - 0.2.3-8
- Add Marathi translations
- Translation by Sandeep Shedmake
- Resolves: #559244

* Wed Jan  6 2010 Marek Kasik <mkasik@redhat.com> - 0.2.3-7.3
- Add libcom_err-devel build dependency
- Related: #543948

* Wed Jan  6 2010 Marek Kasik <mkasik@redhat.com> - 0.2.3-7.2
- rpmlint related changes:
-   Remove explicit dependencies
-   Change Groups
-   Add ChangeLog file to "-devel" docs
- Related: #543948

* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 0.2.3-7.1
- Rebuilt for RHEL 6
